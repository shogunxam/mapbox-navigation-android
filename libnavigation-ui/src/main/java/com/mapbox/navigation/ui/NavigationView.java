...
public class NavigationView extends CoordinatorLayout implements LifecycleOwner, OnMapReadyCallback,
  ...
  /**
   * Updates the text of the speed limit view
   * @param speedLimit to update the view
   */
  @Override public void updateSpeed(SpeedLimit speedLimit) {
    speedLimitView.setSpeedLimit(speedLimit);
  }
  ...
  /**
   * Returns the {@link SpeedLimitView} that shows speed limit
   *
